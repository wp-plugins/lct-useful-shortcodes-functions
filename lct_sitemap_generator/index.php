...
include $g_lct->plugin_dir_path . 'lct_sitemap_generator/lang/' . $ddsg_lang_file . '.php';
	...
	<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
			...
			<tr valign="top">
				...
				<td align="left">
					<select name="ddsg_language">
						...
						$language_list = [ ];
						$handle = opendir( $g_lct->plugin_dir_path . 'lct_sitemap_generator/lang' );
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				...
				<td valign="top">
					<input name="ddsg_what_to_show" type="radio" value="both" <?php if( get_option( 'ddsg_what_to_show' ) == "both" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_SHOW_BOTH; ?>
					<br />
					<input name="ddsg_what_to_show" type="radio" value="posts" <?php if( get_option( 'ddsg_what_to_show' ) == "posts" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_SHOW_POSTS; ?>
					<br />
			...
			<tr>
				...
				<td valign="top">
					<input name="ddsg_which_first" type="radio" value="posts" <?php if( get_option( 'ddsg_which_first' ) == "posts" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_WHICH_FIRST_POSTS; ?>
					<br />
			...
			<tr>
				...
				<td valign="top">
					<label><input name="ddsg_post_sort_order" type="radio" value="title" <?php if( get_option( 'ddsg_post_sort_order' ) == "title" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_T; ?>
						<br /></label>
					<label><input name="ddsg_post_sort_order" type="radio" value="datea" <?php if( get_option( 'ddsg_post_sort_order' ) == "datea" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_DA; ?>
						<br /></label>
					<label><input name="ddsg_post_sort_order" type="radio" value="dated" <?php if( get_option( 'ddsg_post_sort_order' ) == "dated" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_POST_SORT_DD; ?>
						<br /></label>
				</td>
			</tr>
			...
			<tr>
				...
				<td valign="top">
					<label><input name="ddsg_page_sort_order" type="radio" value="title" <?php if( get_option( 'ddsg_page_sort_order' ) == "title" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_T; ?>
						<br /></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="datea" <?php if( get_option( 'ddsg_page_sort_order' ) == "datea" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_DA; ?>
						<br /></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="dated" <?php if( get_option( 'ddsg_page_sort_order' ) == "dated" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_DD; ?>
						<br /></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="menua" <?php if( get_option( 'ddsg_page_sort_order' ) == "menua" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_MA; ?>
						<br /></label>
					<label><input name="ddsg_page_sort_order" type="radio" value="menud" <?php if( get_option( 'ddsg_page_sort_order' ) == "menud" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_PAGE_SORT_MD; ?>
						<br /></label>
				</td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				...
				<td valign="top">
					<!-- editzz cs ORIGINAL - <input name="ddsg_excluded_pages" type="text" size="55" value="<?php echo get_option( 'ddsg_excluded_pages' ) ?>"/><br />-->
					<textarea name="ddsg_excluded_pages" rows="20" cols="65"><?php echo get_option( 'ddsg_excluded_pages' ) ?></textarea><br />
					<!-- editzz cs ORIGINAL - <?php echo DDSG_EXCLUDED_PAGES_DESC; ?> -->
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				...
				<td valign="top">
					<label><input name="ddsg_page_nav" type="radio" value="1" <?php if( get_option( 'ddsg_page_nav' ) == 1 ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV1_PAGE . ' 2 of 5 : <a href="#">' . DDSG_NAV1_PREV . '</a> : <a href="#">' . DDSG_NAV1_NEXT . '</a>'; ?>
						<br /></label>
					<label><input name="ddsg_page_nav" type="radio" value="2" <?php if( get_option( 'ddsg_page_nav' ) == 2 ) echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_NAV2_PAGE . ' <a href="#">1</a> 2 <a href="#">3</a> <a href="#">4</a> <a href="#">5</a>'; ?>
					</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td valign="top">
					<label><input name="ddsg_page_nav_where" type="radio" value="top" <?php if( get_option( 'ddsg_page_nav_where' ) == "top" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_TOP; ?>
						<br /></label>
					<label><input name="ddsg_page_nav_where" type="radio" value="bottom" <?php if( get_option( 'ddsg_page_nav_where' ) == "bottom" ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_BOT; ?>
						<br /></label>
					<label><input name="ddsg_page_nav_where" type="radio" value="both" <?php if( get_option( 'ddsg_page_nav_where' ) == "both" ) echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_NAV_WHERE_BOTH; ?>
					</label>
				</td>
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6">
			...
			<tr>
				...
				<td valign="top">
					<label><input name="ddsg_xml_where" type="radio" value="last" <?php if( get_option( 'ddsg_xml_where' ) == 'last' ) echo "checked='checked'"; ?> />&nbsp;&nbsp; <?php echo DDSG_XML_WHERE_LAST; ?>
						<br /></label>
					<label><input name="ddsg_xml_where" type="radio" value="every" <?php if( get_option( 'ddsg_xml_where' ) == 'every' ) echo "checked='checked'"; ?>/>&nbsp;&nbsp; <?php echo DDSG_XML_WHERE_EVERY; ?>
					</label>
				</td>
			</tr>
...
function ddsg_create_sitemap() {
	...
	//editzz cs ADDED - 8/2/2013 6:05:14 PM - Allows you to add the page name for reference inside "[]"
	...
	//editzz cs REMOVED - $t_out .= '<div style="text-align: right;"><p style="font-size:90%;">' . DDSG_CREDITS . ' <a href="http://www.dagondesign.com" title="Dagon Design">dagondesign.com</a></p></div>';
