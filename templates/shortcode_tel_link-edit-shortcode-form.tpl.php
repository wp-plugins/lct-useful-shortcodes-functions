...
<script type="text/html" id="tmpl-lct-shortcode-ui-field-text">
	<div class="field-block">
		<label for="lct-shortcode-attr-{{ data.attr }}">{{ data.label }} <a href="#" onclick="return false;" class="lct_tooltip tooltip tooltip_{{data.action}}__{{data.attr}}" title="{{data.tooltip}}"><i class='fa fa-question-circle'></i></a></label>
...
<script type="text/html" id="tmpl-lct-shortcode-ui-field-radio">
	<div class="field-block">
		<label for="lct-shortcode-attr-{{ data.attr }}-{{ value }}">{{ data.label }} <a href="#" onclick="return false;" class="lct_tooltip tooltip tooltip_{{data.action}}__{{data.attr}}" title="{{data.tooltip}}"><i class='fa fa-question-circle'></i></a></label>
		<# _.each( data.options, function( label, value ) { #>
			<input id="lct-shortcode-attr-{{ data.attr }}-{{ value }}" type="radio" name="{{ data.attr }}" value="{{ value }}" <# if ( value == data.value ){ print('checked'); } #>>{{ label }}<br />
		<# }); #>
	</div>
</script>

<script type="text/html" id="tmpl-lct-shortcode-ui-field-checkbox">
		<input type="checkbox" name="{{ data.attr }}" id="lct-shortcode-attr-{{ data.attr }}" value="true" <# var val = ! data.value && data.default != undefined ? data.default : data.value; if ('true' == data.value ){ print('checked'); } #>>
		<label for="lct-shortcode-attr-{{ data.attr }}">{{ data.label }} <a href="#" onclick="return false;" class="lct_tooltip tooltip tooltip_{{data.action}}__{{data.attr}}" title="{{data.tooltip}}"><i class='fa fa-question-circle'></i></a></label>
</script>
